...
public class TreeUtilsFindTestCase {
	...
	Node<String> tree = new SimpleNode<String>("child");
	Node<String> m = new SimpleNode<String>("mother");
	Node<String> f = new SimpleNode<String>("father");
	Node<String> gm = new SimpleNode<String>("grandmother");
	Node<String> gf = new SimpleNode<String>("grandfather");
	...
	public void testFindNodeSingleNodeTree_Ok() {
		Node<String> root = new SimpleNode<String>("root");
	...
	public void testFindNode4() {
		tree.addChild(new SimpleNode<String>("grandfather"));
		log.debug("test - tree:\n" + tree.toStringAsTree());
	...
	public void testFindNodeFail3_MultipleSameNodesOnTheSameLevel() {
		f.addChild(new SimpleNode<String>("grandfather"));
		log.debug("test - tree:\n" + tree.toStringAsTree());
	...
	public void testFindNodeFail4_MultipleSameNodesOnTheSameLevel() {
		tree.addChild(new SimpleNode<String>("father"));
		log.debug("test - tree:\n" + tree.toStringAsTree());
	...
	public void testFindNodeFail5_PathLongerThanTreeDepth() {
		...
		TreeUtils.getNode(tree, 
				new StringNodeMatcher("child"), new StringNodeMatcher("father"), new StringNodeMatcher("grandfather"), new StringNodeMatcher("grandgrandfather"));
	}
