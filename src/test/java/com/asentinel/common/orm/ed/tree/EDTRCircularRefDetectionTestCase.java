...
public class EDTRCircularRefDetectionTestCase {
	...
	private static final Logger log = LoggerFactory.getLogger(EDTRCircularRefDetectionTestCase.class);
	...
	public void testCircularReferenceDetection1() {
		IllegalStateException e = assertThrows(IllegalStateException.class, () -> {
			edtr.getEntityDescriptorTree(Order3.class, (node, builder) -> {
		...
		assertTrue(e.getMessage().toUpperCase().contains("CIRCULAR"));
	}
